...
{{--                            @dd($mediaPhoto)--}}
                            <div class="col-md-3" style="margin-bottom: 10px">
                                   <img src="{{asset($mediaPhoto->getUrl())}}" style="width:100%;height:132px">
                                    <button class="btn btn-secondary btn-sm" aria-label="copied" data-clipboard-text="{{asset($mediaPhoto->getUrl())}}">{{__('Copy Path')}}</button>
