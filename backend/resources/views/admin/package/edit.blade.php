...
@section('content')
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{route('admin.package.update',$package->id)}}"  enctype="multipart/form-data" accept-charset="utf-8" file="true">
                    @csrf
                    @method('Put')
                    <div class="card">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="package_time_id" class="custom-select form-control auto-save" required >
                                            ...
                                            @foreach($packageTimes as $time)
                                                <option {{$package->package_time_id == $time->id ?'selected' : ''}} value="{{ $time->id }}">{{ $time->time }} {{__('Minute')}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{$package->days}}" name="days" class="form-control" id="days" placeholder="Enter Number OF Days Per Week" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="price">{{ __('Classes / Month') }}*</label>
                                        <input type="number"  value="{{$package->classes}}" onkeyup="totalPrice()" name="classes" class="form-control" id="classes" placeholder="Enter Number OF Classes Per Month"  required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="class_price"  value="{{$package->class_price}}" onkeyup="totalPrice()" class="form-control" id="price" placeholder="Enter price" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="price">{{ __('Total Price') }}*</label>
                                        <input type="text" name="total_price"  value="{{$package->total_price}}" class="form-control" id="total" placeholder=""  readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                                ...
                                                <input type="number" max="100" min="0" name="Months6" class="form-control" value="{{$package->Months6}}" aria-describedby="basic-addon1">
                                            </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                                ...
                                                <input type="number" name="Months12" max="100" min="0" value="{{$package->Months12}}" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
                                            </div>
                                    </div>
...
@section('script')
    <script>
        function totalPrice(){
            let classes =  parseInt($('#classes').val());
