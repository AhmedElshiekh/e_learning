...
{{--                </li>--}}
                        ...
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="{{url('admin/courses')}}">
                                    <span class="sub-item">{{__('Recorded Courses')}}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/liveCourses')}}">
                                    <span class="sub-item">{{__('Live Courses')}}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/categoryCourse')}}">
                                    <span class="sub-item">{{__('Categories')}}</span>
                                </a>
                            </li>
                            {{-- <li>
                                <a href="{{url('admin/courseSetting')}}">
                                    <span class="sub-item">{{__('Setting')}}</span>
                                </a>
                            </li> --}}
                            {{-- <li>
                                <a href="{{url('admin/orders')}}">
                                    <span class="sub-item">{{__('Free Requests')}}</span>
                                </a>
                            </li> --}}
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="classes">
                        <ul class="nav nav-collapse">
                            ...
                            <li>
                                <a href="{{url('admin/requestClasses')}}">
                ...
                <li class="nav-item">
                    <a data-toggle="collapse" href="#exams">
                        ...
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{url('admin/exams/create')}}">
                                    <span class="sub-item">{{__('Create Exam')}}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/exams/')}}">
                                    <span class="sub-item">{{__('All Exams')}}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{url('admin/question')}}">
                                    <span class="sub-item">{{__('Question Bank')}}</span>
                                </a>
                            </li>
