                                            ...
                                            <tr>
                                                <td>
                                                    @if($catBlog->hasMedia('catBlog'))
                                                        <div class="flag">
                                                            <img width="80" height="80" src="{{ asset($catBlog->lastMedia('catBlog')->getUrl()) }}">
                                                        </div>
                                                    @endif
                                                </td>
                                                <td>{{$catBlog->name}}</td>
                            ...
                            <div class="col-md-2   text-center">
                                <div class="form-group" id="imgPreview">
                                    @if($category->hasMedia('blog'))
                                        <img src="{{asset($category->firstMedia('blog')->getUrl())}}" class="img-fluid"
                                             alt="">
                                    @else
